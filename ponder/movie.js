...
//                 <p><strong>Rating:</strong> <span aria-label="5 out of 5 starts" role="img">⭐⭐⭐⭐⭐</span></p>
...
movies.forEach(movie => {
        ...
        let html = `
            ...
            <p><strong>Rating:</strong> <span aria-label="${movie.stars.length} out of 5 starts" role="img">${movie.stars}</span></p>
